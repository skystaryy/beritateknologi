...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Cek apakah folder ada atau buat jika belum ada
    ...
    if (move_uploaded_file($tmp_name, $upload_dir . $foto)) {
        ...
        $sql = "INSERT INTO galeri (foto) VALUES ('$foto')";
        if (mysqli_query($koneksi, $sql)) {
            // Jika query berhasil, redirect ke halaman galeri
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
          ...
          <span class="ms-1 font-weight-bold">Galeri</span>
        </a>
      </div>
      ...
      <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Tambah Foto</h6>
          </nav>
          ...
          <div class="col-12">
            <div class="card mb-4">
              ...
              <div class="card-body px-0 pt-0 pb-2">
                ...
                <form method="POST" action="tambahgaleri.php" enctype="multipart/form-data">
