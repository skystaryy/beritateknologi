              ...
              <div class="card-body px-0 pt-0 pb-2">
                ...
                <form method="POST" action="tambahadmin.php">
                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        ...
                        <input type="text" name="username" placeholder="Masukan Username" class="form-control" required><br>
                    </div>
                    
                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        <label for="email">Email:</label>
                        <input type="email" name="email" placeholder="Masukan Email" class="form-control" required><br>
                    </div>
