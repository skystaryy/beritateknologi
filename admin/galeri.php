                ...
                <div class="table-responsive p-0">
                  <table class="table align-items-center mb-0">
                    <thead>
                      ...
                      <tbody>
                      <a href="tambahgaleri.php" class="btn btn-md btn-success" style="margin-left: 20px;">TAMBAH DATA</a>
                      <?php 
                        ...
                        <tr>
                        <td><?=$no++?></td>
                        <td><?="<img src='artikel/$data[foto]' width='140' height='80' />";?></td>

                        <td class="text-center">
                              <a href="editgaleri.php?id=<?php echo $data['id'] ?>" type= "button" class="btn btn-sm btn-primary">EDIT</a>
                              <a href="deletegaleri.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Anda Yakin Ingin Menghapus data galeri ini?')" type="button" class="btn btn-danger btn-md">HAPUS</a>
                        </td>
                        </tr>                                    
                <?php               
	                }
