...
// Mendapatkan data dari database untuk pre-fill form
$judul = $data['judul'];
$penulis = $data['penulis'];
$tanggalwaktu = $data['tanggalwaktu'];
$isi = $data['isi'];
$link = $data['link'];
$gambar_lama = $data['gambar']; // Simpan nama gambar lama jika ada
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $tanggalwaktu = $_POST['tanggalwaktu'] ?? null;
    $isi = $_POST['isi'] ?? null;
    $link = $_POST['link'] ?? null;

    // Validasi file upload
    $gambar = $_FILES['gambar']['name'] ?? null;
    $tmp_name = $_FILES['gambar']['tmp_name'] ?? null;
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
          ...
          <span class="ms-1 font-weight-bold">Edit Artikel</span>
        </a>
      </div>
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Artikel</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Edit Artikel
          </nav>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <form method="POST" action="editartikel.php" enctype="multipart/form-data">
                        <!-- Hidden field untuk menyimpan id artikel -->
                        <input type="hidden" name="id" value="<?= $data['id']; ?>">

                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            <label for="judul">Judul:</label>
                            <input type="text" name="judul" placeholder="Masukan Judul Artikel" class="form-control" value="<?= $data['judul']; ?>" required><br>
                        </div>
                        
                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            <label for="penulis">Penulis:</label>
                            <input type="text" name="penulis" placeholder="Masukan Nama Penulis" class="form-control" value="<?= $data['penulis']; ?>" required><br>
                        </div>

                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            <label for="tanggalwaktu">Tanggal:</label>
                            <input type="date" name="tanggalwaktu" class="form-control" value="<?= $data['tanggalwaktu']; ?>" required><br>
                        </div>

                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            <label for="isi">Isi:</label>
                            <textarea name="isi" placeholder="Masukan isi dari Artikel" class="form-control" rows="5" required><?= $data['isi']; ?></textarea>
                        </div>

                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            <label for="gambar">Upload Gambar:</label>
                            <input type="file" name="gambar" id="gambar" class="form-control" accept=".jpg, .jpeg, .png">
                            <small class="text-muted">Hanya file dengan format JPG, JPEG, atau PNG yang diperbolehkan.</small>
                            <br>
                            <img src="artikel/<?= $data['gambar']; ?>" width="140" height="80" alt="Gambar Lama">
                        </div>

                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            <label for="link">Masukkan Link:</label>
                            <input type="url" name="link" id="link" class="form-control" placeholder="Masukkan URL, misalnya https://example.com" value="<?= $data['link']; ?>">
                        </div>

                        <button class="btn btn-warning btn-reset" style="margin-left: 20px;" type="reset"><i class="fa fa-redo"></i> Reset</button>
