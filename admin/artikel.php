...
if (!isset($_SESSION['username'])) {
    echo "<script>alert('Anda harus login terlebih dahulu!'); window.location.href='signin.html';</script>";
    exit();
}
?>
      ...
      <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Artikel</h6>
          </nav>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity->">Link</th>
                      ...
                      <tbody>
                      <a href="tambahartikel.php" class="btn btn-md btn-success" style="margin-left: 20px;">TAMBAH DATA</a>
                      <?php 
                        ...
                        <td><?="<img src='artikel/$data[gambar]' width='140' height='80' />";?></td>
                        <td><?=substr($data['link'], 0, 30)?> . . .</td>
                        <td class="text-center">
                              <a href="editartikel.php?id=<?php echo $data['id'] ?>" type= "button" class="btn btn-sm btn-primary">EDIT</a>
                              <a href="deleteartikel.php?id=<?php echo $data['id'] ?>" onclick="return confirm('Anda Yakin Ingin Menghapus data artikel ini?')" type="button" class="btn btn-danger btn-md">HAPUS</a>
                        </td>
                        </tr>                                    
                <?php               
	                }
