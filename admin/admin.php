                ...
                <div class="table-responsive p-0">
                  <table class="table align-items-center mb-0">
                    <thead>
                      ...
                      <tbody>
                      <a href="tambahadmin.php" class="btn btn-md btn-success" style="margin-left: 20px;">TAMBAH DATA</a>
                        <?php 
                            include('koneksi.php');
                            $no = 1;
                          //$query = mysqli_query($connection,"SELECT * FROM jeniskegiatan");
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                              <a href="editadmin.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                              <a href="deleteadmin.php?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                            </td>
                        </tr>
                      <?php } ?>
                      </tbody>
