...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (move_uploaded_file($tmp_name, $upload_dir . $gambar)) {
      ...
      $sql = "INSERT INTO artikel (judul, penulis, tanggalwaktu, isi, gambar, link) VALUES ('$judul', '$penulis', '$tanggalwaktu', '$isi', '$gambar', '$link')";
      if (mysqli_query($koneksi, $sql)) {
          // Jika query berhasil, redirect ke halaman artikel
    ...
    $sql = "INSERT INTO artikel (judul, penulis, tanggalwaktu, isi, gambar, link) VALUES ('$judul', '$penulis', '$tanggalwaktu','$isi', '$gambar','$link')";
    if (mysqli_query($koneksi, $sql)) {
        // Jika query berhasil, redirect ke halaman admin.php
        header('Location: artikel.php');
        exit();
    } else {
      echo "Error: " . $sql . "<br>" . mysqli_error($koneksi);
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
          ...
          <span class="ms-1 font-weight-bold">Artikel</span>
        </a>
      </div>
          ...
          <div class="col-12">
            <div class="card mb-4">
              ...
              <div class="card-body px-0 pt-0 pb-2">
                ...
                <form method="POST" action="tambahartikel.php" enctype="multipart/form-data">
                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        <label for="judul">Judul:</label>
                        <input type="text" name="judul" placeholder="Masukan Judul Artikel" class="form-control" required><br>
                    </div>
                    
                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        <label for="penulis">Penulis:</label>
                        <input type="text" name="penulis" placeholder="Masukan Nama Penulis" class="form-control" required><br>
                    </div>

                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        <label for="tanggalwaktu">Tanggal:</label>
                        <input type="date" name="tanggalwaktu" placeholder="Masukan Tanggal" class="form-control"><br>
                    </div>

                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        <label for="isi">Isi</label>
                        <textarea name="isi" placeholder="Masukan isi dari Artikel" class="form-control" rows="5"></textarea>
                    </div>
                    ...
                    <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                        ...
                        <input type="url" name="link" id="link" class="form-control" placeholder="Masukkan URL, misalnya https://example.com">
                    </div>
                ...
                <!-- <a href="admin.php">Kembali ke Daftar Admin</a> -->
                </div>
              </div>
            </div>
          </div>
