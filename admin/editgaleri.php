...
$gambar_lama = $data['foto']; // Simpan nama gambar lama jika ada
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_query($koneksi, $sql)) {
        header('Location: galeri.php'); // Redirect ke halaman daftar artikel
        exit();
    } else {
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
          ...
          <span class="ms-1 font-weight-bold">Edit Foto</span>
        </a>
      </div>
      ...
      <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">Edit Foto
          </nav>
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <form method="POST" action="editgaleri.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group" style="margin-left: 20px; margin-right: 20px;">
                            ...
                            <br>
                            <img src="artikel/<?= $data['foto']; ?>" width="140" height="80" alt="Gambar Lama">
                        </div>
